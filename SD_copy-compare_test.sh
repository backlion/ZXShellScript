...
then
	...
	echo "start SD to USB flash disk test|copy /storage/extsdcard/CPFILE folder to /storage/usbdisk1" >> different_storage_copy-compare_test.log
	date
	date >> different_storage_copy-compare_test.log
	...
	echo "finish SD to USB flash disk test" >> different_storage_copy-compare_test.log
else
