...
then
	...
	echo "start emmc to USB flash disk test|copy $path/CPFILE folder to /storage/usbdisk1" >> different_storage_copy-compare_test.log
	date
	date >> different_storage_copy-compare_test.log
	...
	echo "finish emmc to USB flash disk test" >> different_storage_copy-compare_test.log
else
