...
echo "different_storage_performance_test version: 1.0"  >> different_storage_copy-compare_test.log
...
cpfile_size=`ls -l /data/different_storage_performance_test/CPFILE | awk '{total+=$4} END {print total}'`
echo "CPFILE folder size is $cpfile_size byte"
echo "CPFILE folder size is $cpfile_size byte" >> different_storage_copy-compare_test.log
#wait for HDD ready
if test -z $1
then
...
echo "finish different_storage_performance_test" >> different_storage_copy-compare_test.log
echo "////////////////////////////////////////////////////////////////"
#echo "result:"
