...
2.将整个different_storage_performance_test文件夹拷贝到/data目录下
...
5.log文件保存在脚本同文件夹下different_storage_performance_test.log

note:
1.每次拷贝后会会打印这次拷贝的速度,有byte/s、KB/s、MB/s三个精度,每项测试完成之后会打印一个平均速度
